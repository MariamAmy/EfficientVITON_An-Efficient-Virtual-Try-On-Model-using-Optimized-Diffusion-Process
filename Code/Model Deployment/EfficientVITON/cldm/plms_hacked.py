...
class PLMSSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="non-uniform", ddim_eta=0., verbose=True):
        ...
        elif ddim_discretize == "non-uniform":
            self.ddim_timesteps = torch.tensor([0, 199, 399, 599, 699, 799, 849, 899, 949, 999],
                                                 dtype=torch.long, device=self.model.device)

            if self.ddpm_num_timesteps != 1000: #scaling for different total number of steps.
                self.ddim_timesteps = (self.ddim_timesteps * (self.ddpm_num_timesteps / 1000)).long()
